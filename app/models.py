...
class Role(db.Model):
    ...
    def insert_roles():
        roles = {
            'User': (Permission.SEE | Permission.EDIT
                     , True),
...
class Post(db.Model):
    ...
    @staticmethod
    def from_json(json_post, ValidationError=None):
...
class Country(db.Model):
    ...
    en_US = db.Column(db.String(100))
    zh_CN = db.Column(db.String(100))
    def to_json(self):
        json_post = {
            'country': self.iso2
        }
...
class VsimManualInfor(db.Model):
    """

    """
    __tablename__ = 'vsim_manual_infor'

    imsi = db.Column(db.String(16), primary_key=True)
    person_gsvc = db.Column(db.String(16))
    country_iso = db.Column(db.String(2))
    country_cn = db.Column(db.String(16))
    operator = db.Column(db.String(16))
    iccid = db.Column(db.String(24))
